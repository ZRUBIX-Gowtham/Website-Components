...
/**
 * V16-responsive.js
 * - Mobile: single column stack (one-by-one, column-wise).
 * - Desktop (sm and up): original 5x5 grid preserved via sm:... Tailwind utilities.
...
export default function V193() {
  ...
  const vars = {
    ...
    "--panel": isDark ? "#000000" : "#ffffff",
    "--text": isDark ? "#e6eef8" : "#0f172a",
    "--muted": isDark ? "#9aaec0" : "#64748b",
    "--border": isDark ? "rgba(255,255,255,0.18)" : "#e6eef2",
  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        {/* Mobile-first: single column. Desktop (sm: ) restores 5x5 layout */}
        <div className="grid grid-cols-1 sm:grid-cols-5 sm:grid-rows-5 gap-4 relative z-10">
          <article
            aria-label="cell-1"
            className="rounded-2xl p-6 flex flex-col justify-between transform transition sm:col-span-2 sm:row-span-4"
            style={panelStyle}
          >
            <div>
          ...
          <section
            aria-label="cell-2"
            className="rounded-2xl p-5 flex flex-col justify-between transform transition sm:col-span-2 sm:row-span-2 sm:col-start-3 sm:row-start-2"
            style={panelStyle}
          >
            <div>
          ...
          <section
            aria-label="cell-3"
            className="rounded-2xl p-5 flex flex-col justify-between transform transition sm:col-span-2 sm:row-span-2 sm:col-start-3 sm:row-start-4"
            style={panelStyle}
          >
            <div>
              <h3 className="text-lg font-medium mb-2" style={{ color: "var(--text)" }}>
          ...
          <div
            aria-label="cell-4"
            className="rounded-xl p-4 flex flex-col justify-between transform transition sm:row-span-2 sm:col-start-5 sm:row-start-1"
            style={panelStyle}
          >
            <div>
          ...
          <div
            aria-label="cell-5"
            className="rounded-xl p-4 flex flex-col justify-between transform transition sm:row-span-2 sm:col-start-5 sm:row-start-4"
            style={panelStyle}
          >
            <div>
              <h4 className="text-sm font-semibold" style={{ color: "var(--text)" }}>
          ...
          <div
            aria-label="cell-6"
            className="rounded-lg p-3 flex items-center justify-center text-sm font-medium transition sm:col-start-1 sm:row-start-5"
            style={smallStyle}
          >
            Team
          </div>
          ...
          <div
            aria-label="cell-7"
            className="rounded-lg p-3 flex items-center justify-center text-sm font-medium transition sm:col-start-2 sm:row-start-5"
            style={smallStyle}
          >
            Careers
          </div>
          ...
          <div
            aria-label="cell-8"
            className="rounded-lg p-3 flex items-center justify-center text-sm font-medium transition sm:col-start-3 sm:row-start-1"
            style={smallStyle}
          >
            Design
          </div>
          ...
          <div
            aria-label="cell-9"
            className="rounded-lg p-3 flex items-center justify-center text-sm font-medium transition sm:col-start-4 sm:row-start-1"
            style={smallStyle}
          >
            Docs
          </div>
          ...
          <div
            aria-label="cell-10"
            className="rounded-lg p-3 flex items-center justify-center text-sm font-medium transition sm:col-start-5 sm:row-start-3"
            style={smallStyle}
          >
            Media
          </div>
