    ...
    >
      ...
      <main id="grid" className="max-w-7xl mx-auto px-6 pb-20">
        <div className="grid-wrap rounded-xl overflow-visible">
          {/* Mobile-first: single column; sm: restores 6x6 grid; sm:min-h sets height only on larger screens */}
          <div className="grid grid-cols-1 sm:grid-cols-6 sm:grid-rows-6 gap-4 relative sm:min-h-[760px]" aria-label="decorative-grid">
            {/* 1: sm:col-span-2 sm:row-span-2 */}
            <article className={`${baseCard} sm:col-span-2 sm:row-span-2 ${surface}`}>
            ...
            {/* 2: sm:col-span-2 sm:row-span-2 sm:col-start-2 sm:row-start-3 */}
            <article className={`${baseCard} sm:col-span-2 sm:row-span-2 sm:col-start-2 sm:row-start-3 ${surface}`}>
            ...
            {/* 3: sm:col-span-2 sm:row-span-2 sm:col-start-3 sm:row-start-5 */}
            <article className={`${baseCard} sm:col-span-2 sm:row-span-2 sm:col-start-3 sm:row-start-5 ${surface}`}>
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="font-semibold">Lorem ipsum </h3>
                  <p className={`text-sm mt-1 ${textMuted}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            ...
            {/* 5: sm:col-span-2 sm:row-span-2 sm:col-start-5 sm:row-start-3 */}
            <article className={`${baseCard} sm:col-span-2 sm:row-span-2 sm:col-start-5 sm:row-start-3 ${surface}`}>
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="font-semibold">Lorem ipsum </h3>
                  <p className={`text-sm mt-1 ${textMuted}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            ...
            {/* 6: sm:col-span-2 sm:row-span-2 sm:col-start-1 sm:row-start-5 */}
            <article className={`${baseCard} sm:col-span-2 sm:row-span-2 sm:col-start-1 sm:row-start-5 ${surface}`}>
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="font-semibold">Lorem ipsum </h3>
                  <p className={`text-sm mt-1 ${textMuted}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            ...
            {/* 7: sm:col-span-2 sm:row-span-2 sm:col-start-5 sm:row-start-5 */}
            <article className={`${baseCard} sm:col-span-2 sm:row-span-2 sm:col-start-5 sm:row-start-5 ${surface}`}>
              <div className="flex justify-between items-start">
                <div>
                  <h3 className="font-semibold">Lorem ipsum </h3>
                  <p className={`text-sm mt-1 ${textMuted}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            ...
            {/* 10: sm:col-span-2 sm:row-span-2 sm:col-start-3 sm:row-start-1 */}
            <article className={`${baseCard} sm:col-span-2 sm:row-span-2 sm:col-start-3 sm:row-start-1 ${surface}`}>
              <div className="flex items-start gap-4">
            ...
            {/* 16: sm:col-span-2 sm:row-span-2 sm:col-start-5 sm:row-start-1 */}
            <article className={`${baseCard} sm:col-span-2 sm:row-span-2 sm:col-start-5 sm:row-start-1 ${surface}`}>
              <div className="flex items-start gap-4">
            ...
            {/* Small items (kept as sm: positioned) */}
            {/* 17: sm:row-span-2 sm:col-start-1 sm:row-start-3 */}
            <div className={`${baseSmall} sm:row-span-2 sm:col-start-1 sm:row-start-3 ${surface}`}>
            ...
            {/* 18: sm:row-span-2 sm:col-start-4 sm:row-start-3 */}
            <div className={`${baseSmall} sm:row-span-2 sm:col-start-4 sm:row-start-3 ${surface}`}>
              <div className="flex items-center justify-between">
                <div>
