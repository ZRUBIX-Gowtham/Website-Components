...
function V151({ showScrolledVariant = true }) {
  ...
  // Menu items replaced with lorem ipsum names and links
  const menuItems = [
    { name: 'Lorem', link:'/lorem' },
    {
      name: 'Ipsum',
      link:  '/ipsum',
      dropdown: [
        { name: 'Dolor', link: '/ipsum/dolor' },
        { name: 'Sit Amet', link: '/ipsum/sit-amet' },
      ]
    },
    { name: 'Consectetur', link: '/consectetur' },
    { name: 'Adipiscing', link: '/adipiscing' },
    { name: 'Elam', link: '/elam' },
  ];

  // --- CONFIG: kept contact values but display text replaced with lorem ---
  const phoneNumberDisplay = '+91 9894352229';
  const phoneNumberDial = '919894352229'; // no plus, no spaces (for tel: and wa.me)
  const emailAddress = 'lorem.ipsum@example.com';
  const fullAddress = '123 Lorem Ipsum St, Dolor City, State 000000';
  const whatsappMessage = encodeURIComponent('Lorem ipsum dolor sit amet, I would like to inquire.');
  ...
  const toggleSideMenu = () => {
    setIsSideMenuOpen(prev => {
      const next = !prev;
      if (next) setIsContactOverlayOpen(false);
  ...
  const toggleContactOverlay = () => {
    setIsContactOverlayOpen(prev => {
      const next = !prev;
      if (next) setIsSideMenuOpen(false);
      return next;
    });
  };
    ...
    <>
      ...
      <header className={`fixed top-0  left-0 w-full z-[1000] transition-all duration-300 ${isScrolled && showScrolledVariant ? 'bg-white shadow-md' : 'bg-transparent'}`}>
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            <ul className="flex  text-left items-center space-x-8">
        ...
        <div className="pt-10 px-4 pb-8 flex flex-col h-full">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {item.dropdown && (
                    <button
                      ...
                      aria-label="Toggle lorem submenu"
                    >
          ...
          <div className="mt-6 px-5">
            <button
              onClick={() => {
                setIsSideMenuOpen(false);
                setTimeout(() => setIsContactOverlayOpen(true), 60);
              }}
      ...
      >
        <div className="pt-1 px-6 pb-8 overflow-auto">
          <button onClick={toggleContactOverlay} className="block text-3xl text-[#274760] hover:text-[#007bff] mb-4">
            &times;
          </button>
          ...
          <div className="max-w-[420px] mx-auto">
            ...
            <div className="flex items-center justify-center mb-6 border-b pb-6 gap-3">
              <div className="text-center">
                <h3 className="text-2xl font-bold text-[#274760]">Contact Lorem</h3>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div className="flex-1">
                  <div className="text-[#274760] font-semibold">Lorem Phone</div>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="text-[#274760] font-semibold">Lorem Email</div>
            ...
            <div className="mt-6">
              ...
              >
                ...
                <span>Lorem WhatsApp</span>
              </a>

              <div className="border-t pt-6 mt-4">
                <h4 className="text-[#274760] font-semibold mb-3">Subscribe (Lorem)</h4>
                <div className="flex gap-2 border rounded-md overflow-hidden">
                  <input type="email" placeholder="lorem@ipsum.com" className="flex-1 px-4 py-2 outline-none text-[#274760]" />
                  <button className="bg-[#007bff] text-white px-4 py-2 font-semibold">Lorem Submit</button>
                </div>
