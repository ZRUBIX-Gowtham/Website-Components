        ...
        <div className="max-w-[1700px] mx-auto ">
          ...
          <div className="w-full">
            ...
            >
              ...
              <div className="shrink-0 w-[62vw] sm:w-[72vw] md:w-[40vw] lg:w-[38vw] max-w-[1000px] relative rounded-3xl overflow-visible px-4 sm:px-6 py-2 sm:py-2">
