...
export function V157() {
  const heroData = {
    heroContent: {
      title: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit',
      description:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam.',
      ctaPrimary: { label: 'Lorem ipsum dolor', action: 'openModal' },
      ctaSecondary: { label: 'Call +91 1234567890', href: 'tel:+911234567890' },
    },
    doctorImage: {
      src: doctorimage,
      alt: 'Doctor',
  ...
  // detect mobile (initial value uses window when available to avoid flicker)
  ...
  // Parallax effect — enabled only when not mobile and when elements exist
  useEffect(() => {
    const section = sectionRef.current || document.querySelector('.hero-section');
    const text = textRef.current || document.querySelector('.hero-content');
    const figure = figureRef.current || document.querySelector('.doctor-figure');

    // If mobile or missing any target, do not attach parallax
    if (isMobile || !section || !text || !figure) {
      // ensure any running RAF is cancelled
      if (rafIdRef.current) {
  ...
  return (
    <>
      ...
      <style jsx>{`
        /* Mobile first: single column, centered text, hide image via conditional render */
        .hero-section {
        ...
        /* Desktop and larger: two columns, left-aligned text, show image */
      ...
      >
        ...
        >
          <div className="pills flex flex-wrap gap-2 mb-3 justify-center md:justify-start" aria-label="Specialties">
          ...
          <div className="cta-row flex flex-wrap gap-3 mt-2 justify-center md:justify-start" role="group" aria-label="Primary actions">
            <button
        ...
        {/* Only render the image block when NOT mobile */}
        {!isMobile && (
          <div className="right-col-with-image">
            <div className="right-col relative grid items-end justify-items-center h-[600px] w-full">
              <div
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-[1000] ">
          <div className="relative bg-white p-8 rounded-lg w-[90%] max-w-[500px] shadow-lg z-[5] ">
            ...
            <h4 className="text-2xl mb-5 text-[#333]">Lorem ipsum dolor</h4>
