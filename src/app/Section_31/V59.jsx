  ...
  return (
    <section className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg sm:text-xl font-semibold tracking-tight">New Arrivals</h3>
      ...
      <div className="relative">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {visible.map((p) => {
            ...
            const transform = hovering ? 'scale(1.06)' : 'scale(1)';
            const filter = hovering ? 'brightness(1.04)' : 'brightness(1)';
                  ...
                  >
                    {p.images.map((img, idx) => (
                      <button
                        ...
                        className={`w-2.5 h-2.5 rounded-full ring-1 ring-white shadow-sm transform transition-all duration-150 ${sel === idx ? 'scale-110 ring-2 ring-gray-900' : 'opacity-80'}`}
